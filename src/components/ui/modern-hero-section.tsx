...
export default function HeroGeometric({
  badge = "AI-Powered",
  title1 = "Automated Meeting",
  title2 = "Minutes Generator",
}: {
  badge?: string
  title1?: string
  title2?: string
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-foreground/60 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Record meetings directly in your browser. Our AI instantly transcribes and converts your sessions into clear summaries, action items, and key decisions.
            </p>
          </motion.div>
